...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp64/www/FETITANIO/app/cache/prod/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp64/www/FETITANIO/app/cache/prod/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp64/www/FETITANIO/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp64/www/FETITANIO/app/Resources');
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager5bb29a405b956_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager5bb29a405b956_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'C:/wamp64/www/FETITANIO/app/cache/prod/jms_diextra/doctrine/EntityManager_5bb29a405b956.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_4749086c2e23d9913aef31dd6bc0cb76');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_4749086c2e23d9913aef31dd6bc0cb76');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_4749086c2e23d9913aef31dd6bc0cb76');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp64\\www\\FETITANIO\\src\\JOYAS\\JoyasBundle\\Entity')), 'JOYAS\\JoyasBundle\\Entity');
        ...
        $e->setProxyDir('C:/wamp64/www/FETITANIO/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5bb29a405b956_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp64/www/FETITANIO/app/Resources');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/wamp64/www/FETITANIO/app/cache/prod/jms_diextra/metadata'));
    ...
    {
        return $this->services['knp.snappy.pdf'] = new \Knp\Snappy\Pdf('C:/wamp64/www/FETITANIO/app/wkhtmltopdf', array('lowquality' => false, 'enable-javascript' => true, 'debug-javascript' => true));
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/wamp64/www/FETITANIO/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp64/www/FETITANIO/app/config/routing.yml', array('cache_dir' => 'C:/wamp64/www/FETITANIO/app/cache/prod', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appProdUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appProdUrlMatcher', 'strict_requirements' => NULL), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp64/www/FETITANIO/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/wamp64/www/FETITANIO/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp64/www/FETITANIO/app/cache/prod/sessions');
    }
    ...
    protected function getSiphoc_Pdf_CssToHtmlService()
    {
        ...
        $instance->setBasePath('C:/wamp64/www/FETITANIO/app/../httpdocs');
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp64/www/FETITANIO/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/wamp64/www/FETITANIO/app/cache/prod/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp64/www/FETITANIO/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp64/www/FETITANIO/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp64\\www\\FETITANIO\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp64\\www\\FETITANIO\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\wamp64\\www\\FETITANIO\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp64\\www\\FETITANIO\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp64\\www\\FETITANIO\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\wamp64\\www\\FETITANIO\\src\\JOYAS\\JoyasBundle/Resources/views', 'JOYASJoyas');
        $instance->addPath('C:/wamp64/www/FETITANIO/app/Resources/views');
        $instance->addPath('C:\\wamp64\\www\\FETITANIO\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        $instance->addPath('C:\\wamp64\\www\\FETITANIO\\vendor\\knplabs\\knp-menu\\src\\Knp\\Menu/Resources/views');
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp64/www/FETITANIO/app/../web', true);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp64/www/FETITANIO/app/cache/prod');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\wamp64\\www\\FETITANIO\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp64/www/FETITANIO/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp64/www/FETITANIO/app/cache/prod',
            'kernel.logs_dir' => 'C:/wamp64/www/FETITANIO/app/logs',
            ...
            'debug.container.dump' => 'C:/wamp64/www/FETITANIO/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp64/www/FETITANIO/app/cache/prod/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\wamp64\\www\\FETITANIO\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'router.resource' => 'C:/wamp64/www/FETITANIO/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp64/www/FETITANIO/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'assetic.cache_dir' => 'C:/wamp64/www/FETITANIO/app/cache/prod/assetic',
            ...
            'assetic.read_from' => 'C:/wamp64/www/FETITANIO/app/../web',
            'assetic.write_to' => 'C:/wamp64/www/FETITANIO/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp64/www/FETITANIO/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_di_extra.cache_dir' => 'C:/wamp64/www/FETITANIO/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/wamp64/www/FETITANIO/app/cache/prod/jms_diextra/doctrine/EntityManager_5bb29a405b956.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5bb29a405b956_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            'jms_aop.cache_dir' => 'C:/wamp64/www/FETITANIO/app/cache/prod/jms_aop',
            ...
            'siphoc_pdf.basepath' => 'C:/wamp64/www/FETITANIO/app/../httpdocs',
            'siphoc_pdf.options' => array(
                'lowquality' => false,
                'enable-javascript' => true,
                'debug-javascript' => true,
            ),
            'siphoc_pdf.binary' => 'C:/wamp64/www/FETITANIO/app/wkhtmltopdf',
